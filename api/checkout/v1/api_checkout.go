...
func (r ApiCheckoutRequest) Product(product []Product) ApiCheckoutRequest {
	r.product = &product
	return r
}

func (r ApiCheckoutRequest) Execute() (*_nethttp.Response, error) {
 ...
 */
func (a *CheckoutApiService) Checkout(ctx _context.Context) ApiCheckoutRequest {
	return ApiCheckoutRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *CheckoutApiService) CheckoutExecute(r ApiCheckoutRequest) (*_nethttp.Response, error) {
	var (
